...
class SearchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recommend = channel.unary_unary(
                '/search.SearchService/Recommend',
                request_serializer=search__pb2.RecommendRequest.SerializeToString,
                response_deserializer=search__pb2.RecommendResponse.FromString,
                _registered_method=True)
...
def add_SearchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Recommend': grpc.unary_unary_rpc_method_handler(
                    servicer.Recommend,
                    request_deserializer=search__pb2.RecommendRequest.FromString,
                    response_serializer=search__pb2.RecommendResponse.SerializeToString,
            ),
    }
...
class SearchService(object):
    ...
    def Recommend(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/search.SearchService/Recommend',
            search__pb2.RecommendRequest.SerializeToString,
            search__pb2.RecommendResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
